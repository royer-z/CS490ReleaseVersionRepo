...
function takeChecked() {
	...
	.then (newData => { // Data from response ^
		if(newData === 'empty') {
			...
			screen.innerHTML = "<div id='student2TakingExamDiv'><h1 class='studentHeadings'>Please complete&nbsp;"+newData.examName+"</h1><div id='displayExamDiv'><form id='inputExamForm'></form><p id='answerError'></p></div></div>";
